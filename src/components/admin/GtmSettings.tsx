...
export function GtmSettings({ initialContainerId }: { initialContainerId: string }) {
    ...
    <form onSubmit={save} className="space-y-3">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-400">
          Find it in Tag Manager → Workspace, next to the container name. Leave blank to remove.
        </p>
      </div>
