    ...
    pages: [
      {
        ...
        components: [
          ...
          { id: "lf-or", type: "paragraph", content: "or leave your information below", props: { below: true, showOn: "desktop" } },
          { id: "lf-name", type: "shortText", key: "full_name", label: "Full name", placeholder: "Jane Doe", props: { below: true, showOn: "desktop" } },
          { id: "lf-phone", type: "phone", key: "phone", label: "Phone number", placeholder: "(512) 555-0100", props: { below: true, showOn: "desktop" } },
          { id: "lf-email", type: "email", key: "email", label: "Email address", placeholder: "you@example.com", props: { below: true, showOn: "desktop" } },
        ],
      },
      {
