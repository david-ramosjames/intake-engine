  ...
  definition: {
    ...
    pages: [
      {
        ...
        cta: [{ label: "Call Now — Free Consultation", type: "call", value: "+15128838904", style: "primary" }],
        components: [
    ...
    i18n: {
      es: {
        ...
        "cta:welcome:0": "Llamar ahora — Consulta gratis",
        ...
        "cta:details:0": "Llamar ahora — Consulta gratis",
